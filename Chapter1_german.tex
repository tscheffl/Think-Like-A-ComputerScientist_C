...
chemische Formel, $_2Zz$ ist es nicht.
...
Gleichfalls ist, $_2Zz$ nicht legal, weil es kein chemisches Element mit
der Abkürzung $Zz$ gibt.
...
Wenn wir einen Satz in einer natürlichen Sprache wie Deutsch lesen, oder
...
bezeichnen wir als {\bf Parsen}.

\index{parsen}

Wenn wir zum Beispiel den Satz hören  ``Die Würfel sind gefallen.'' 
verstehen wir,  ``Die Würfel'' ist das Subjekt und ``sind gefallen'' das
Verb.  
