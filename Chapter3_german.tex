...
der Fließkommazahlen dar. Fließkommazahlen können 
auch den gebrochenen Anteil der Zahlen darstellen. 
...
Unendlichkeit zu realisieren. Das Ergebnis der folgenden einfachen Division, $10 : 3 = 3,\overline{3}$ weist unendlich viele Nachkommastellen auf.
...
Genaugenommen unterscheidet C zwischen dem Wert
...
Der Grund dafür liegt in dem Ausdruck auf der rechten Seite der
Zuweisung.
Diesen Ausdruck wertet der Computer als Verhältnis zwischen
zwei ganzen Zahlen und deshalb führt C eine Ganzzahldivision
durch, welche den ganzzahligen Wert {\tt 0} als Ergebnis liefert.  
Erst bei der Zuweisung wird dieser Wert in eine Fließkommazahl
konvertiert und das Resultat beträgt  {\tt 0.0}.
...
den Ausdruck auf der rechten Seite als Gleitkommazahl
darzustellen:
...
Der zweite Wert hat wahrscheinlich nichts mehr mit der ursprünglich
 {\tt pi} genannten Speicherstelle in unserem Programm zu tun.
...
Funktion gibt drei Leerzeilen auf dem Bilschirm aus: 
